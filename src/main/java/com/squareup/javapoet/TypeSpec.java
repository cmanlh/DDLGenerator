...
public final class TypeSpec {
    ...
    public final List<CodeBlockNode> codeBlockNodes;
    ...
    private TypeSpec(Builder builder) {
        ...
        this.codeBlockNodes = Util.immutableList(builder.codeBlockNodes);
    ...
    public Builder toBuilder() {
        ...
        builder.codeBlockNodes.addAll(codeBlockNodes);
        return builder;
    }
    ...
    void emit(CodeWriter codeWriter, String enumName, Set<Modifier> implicitModifiers)
        ...
        try {
            ...
            for (CodeBlockNode codeBlockNode : codeBlockNodes) {
                firstMember = codeBlockNode.emit(codeWriter, enumName, implicitModifiers, firstMember);
            }
    ...
    public enum Kind {
        ...
        protected final Set<Modifier> implicitFieldModifiers;
        protected final Set<Modifier> implicitMethodModifiers;
        protected final Set<Modifier> implicitTypeModifiers;
        protected final Set<Modifier> asMemberModifiers;
    ...
    public static final class Builder {
        ...
        private final List<CodeBlockNode> codeBlockNodes = new ArrayList<>();
        ...
        public Builder addCodeBlockNode(CodeBlockNode codeBlockNode) {
            codeBlockNode.init(kind, name);
