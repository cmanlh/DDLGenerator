...
@Deprecated
public class XMLMapperGeneratorDeprecated implements DomGenerator {
    ...
    private SQLFieldPickElementGeneratorDeprecated sqlFieldPickElementGeneratorDeprecated = new SQLFieldPickElementGeneratorDeprecated();
    ...
    private SQLDirectUpdateElementGeneratorDeprecated sqlDirectUpdateElementGeneratorDeprecated = new SQLDirectUpdateElementGeneratorDeprecated();
    ...
    public String generate(Table table, Config config) {
        ...
        root.addElement(sqlFieldPickElementGeneratorDeprecated.getElement(table, config));
        ...
        // update
        if (hasPrimaryKey) {
            root.addElement(sqlDirectUpdateElementGeneratorDeprecated.getElement(table, config));
