...
public class DeleteDynamicElementGenerator implements TableElementGenerator {
    public XmlElement getElement(Table table, Config config) {
        XmlElement element = new XmlElement(XMLTag.DELETE.getName());
        element.addAttribute(new Attribute(XMLAttribute.ID.getName(), "deleteDynamic"));
        ...
        trimElement.addAttribute(new Attribute(XMLAttribute.PREFIX.getName(), ""));
