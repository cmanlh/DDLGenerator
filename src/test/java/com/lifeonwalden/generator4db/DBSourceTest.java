...
public class DBSourceTest {
    ...
    public void setup() throws ClassNotFoundException, SQLException {
        ...
        connection.createStatement()
                        .executeUpdate("create table \"APP_TEST\" (\"ID\" varchar(32), \"NAME\" varchar(32), \"PUBLISHER_address\" varchar(32), \"owner_address_HELLO\" varchar(32))");
    ...
    public void generateCodeMainTest() {
        String[] param = {"D:\\workspace\\DDLGenerator\\resources\\db2xml", "D:\\workspace\\DDLGenerator\\target"};
